...
public class PersonController {
    ...
    @PostMapping("c")
    public ResponseEntity<Integer> create(@RequestBody PersonRequest person) {
        return new ResponseEntity<>(service.createC(person), HttpStatus.CREATED);
    }
    @PostMapping("common")
